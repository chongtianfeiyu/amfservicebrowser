package turbosqel.analizerVisual {
	...
	public class AnalizeItem extends Sprite {
		...
		public static var format:TextFormat = new TextFormat(Style.fontName, 12 , Style.INPUT_TEXT);//new AnalizeFont().fontName
		
		public static var borderColor:uint = Style.TEXT_BACKGROUND;// 0xd1d1d1;
